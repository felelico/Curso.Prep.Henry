...
function saludo(idioma) {
  ...
  // Tu código:
  if (idioma==="aleman"){
    return document.write("guten tag")
  } else if (idioma ==="chino"){
    return document.write("hola chinito")
  }
}
saludo("aleman")
...
function esEntero(numero) {
  ...
  // Tu código:
  if (numero%1===0){
    return document.write("es entero")
  } else {
    return document.write("no es entero")
  }
}
esEntero(5.5)
...
function fizzBuzz(numero) {
 ...
 if (numero % 3 ===0){
   ...
   return document.write("fizzbuzz")
 }
}
fizzBuzz(15)
